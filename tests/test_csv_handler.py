...
user6@test.com,N/A"""
    ...
    def test_remover_duplicatas(self):
        ...
        resultados_unicos = self.csv_handler._remover_duplicatas(
            resultados_com_duplicatas
        )
    ...
    def test_salvar_resultados_csv_com_senha(self):
        ...
        self.csv_handler.salvar_resultados(
            resultados, str(csv_file), incluir_senha=True
        )
    ...
    def test_salvar_resultados_lista_vazia(self):
        ...
        with pytest.raises(
            ValueError, match="Lista de resultados não pode estar vazia"
        ):
...
user3@test.com,senha789"""
        ...
        self.csv_handler.salvar_resultados_json(
            resultados, str(json_file), "entrada.csv"
        )
